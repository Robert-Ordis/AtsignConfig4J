package info.ro.gadget.annotatedconfig.core.instance;
...
import info.ro.gadget.annotatedconfig.core.annotation.ConfigFunc;
import info.ro.gadget.annotatedconfig.core.annotation.ConfigParam;
import info.ro.gadget.annotatedconfig.core.annotation.ConfigSubset;
import info.ro.gadget.annotatedconfig.core.annotation.Constraint;
import info.ro.gadget.annotatedconfig.core.annotation.NotParam;
...
import info.ro.gadget.annotatedconfig.core.instance.deserializer.DeserializerStore;
import info.ro.gadget.annotatedconfig.core.instance.setter.FieldSetter;
import info.ro.gadget.annotatedconfig.core.instance.setter.MemberSetter;
...
public class AcConfigSetterStore {
	...
	Set<Class<? extends AnnotatedConfig>> subsetClasses;
	...
	public AcConfigSetterStore(Class<? extends AnnotatedConfig> moldClazz, DeserializerStore dstores) throws AcWrongClassException{
		...
		this.subsetClasses = new HashSet<Class<? extends AnnotatedConfig>>();
		...
		for(Field field : moldClazz.getDeclaredFields()) {
			...
			try {
				...
				if(subsetAnnotation != null) {
					...
					if(!AnnotatedConfig.class.isAssignableFrom(subClazz)) {
					...
					this.subsetClasses.add((Class<? extends AnnotatedConfig>)subClazz);
					continue;
				}
	...
	public Set<Class<? extends AnnotatedConfig>> getSubClasses(){
